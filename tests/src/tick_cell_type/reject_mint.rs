...
use crate::util::constants::{
    ...
    GOVERNANCE_MEMBER_CELL_TYPE_ARGS, MERCHANT_LOCK_ARGS_1, OWNER_LOCK_ARGS_1, TICK_CELL_TYPE_ARGS, TYPE_ID_ARGS,
};

#[test]
fn test_tick_cell_reject_mint() {
