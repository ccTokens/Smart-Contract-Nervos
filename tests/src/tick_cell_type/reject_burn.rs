use serde_json::json;
use types::constants::Source;

use super::common::{gen_xudt_args, gen_xudt_token_id};
use crate::util;
...
fn test_tick_cell_reject_burn() {
    ...
    let tx = json!({
        ...
        "witnesses":[
            util::gen_tick_cell_witness_args(1, DUMMY_TX_HASH, Source::Input),
            "0x",
            "0x",
            util::gen_action(0, "reject_burn"),
        ]
    });
